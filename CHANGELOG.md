...
#### Changed
- Загрузки: Модуль значительно переписан с интеграцией в роутер, добавлены slug-based URL для разделов и файлов; 301-редиректы с устаревших `?id=` адресов. Добавлен конвертер `install/downloads_slug_converter.php` для генерации slug-ов из названий существующих разделов и файлов.
- Библиотека: Модуль значительно переписан с интеграцией в роутер, добавлены чистые URL на основе slug-ов для разделов и статей; улучшен поиск (полнотекстовый с защитой от XSS и операторных инъекций). Добавлен конвертер `install/library_slug_converter.php` для генерации slug-ов из названий существующих разделов и статей.
