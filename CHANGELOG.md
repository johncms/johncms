...
- Комментарии (загрузки, библиотека): Заменен редактор BB-кодов на CKEditor. Для миграции существующих комментариев из BB-кодов в HTML добавлены одноразовые консольные команды `downloads:convert-comments` и `library:convert-comments`.
