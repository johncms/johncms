...
- Библиотека: Модуль значительно переписан с интеграцией в роутер, добавлены чистые URL; улучшен поиск (полнотекстовый с защитой от XSS и операторных инъекций).
