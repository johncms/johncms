...
### NEW
  ...
  * Добавлен список последних комментариев в Фотоальбомах
...
### NEW
  ...
  * Новая Карта сайта, с оптимизацией для бирж ссылок
