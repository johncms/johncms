...
____________________________________________________________
# JohnCMS 3.0.0 (15.12.2009)
`Деда Гришу с днем рожденья :)`
...
### Major Features
  * Система Бана пользователей
    ...
    * запрет комментариев
  * Возможность открывать / закрывать доступ
...
____________________________________________________________
# JohnCMS 0.2 RC1 (08.02.2008)

`Первый релиз системы, доступный для скачивания`

____________________________________________________________
# JohnCMS 0.1 (10.11.2007 не публиковалась)

`Исходная версия от john77`
