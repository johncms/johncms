...
echo '
<div class="phdr">
    <a href="?"><b>' . _t('Information, FAQ') . '</b></a> | ' . _td('bbCode Tags', 'help') . '
</div>
<div class="menu">
    <p>
    <table cellpadding="3" cellspacing="0">
        <tr>
            <td align="right">[php]...[/php]</td><td>' . _td('PHP code', 'help') . '</td>
            </tr>
        <tr>
            <td align="right">[url=http://site_url]<span style="color:blue">' . _td('Link name', 'help') . '</span>[/url]</td>
