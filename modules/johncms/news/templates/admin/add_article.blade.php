    ...
    <form action="<?= $data['action_url'] ?>" method="post">
        ...
        <div class="form-group">
            ...
            <div class="custom-control custom-checkbox">
                <input type="checkbox" class="form-check-input" name="active" value="1" id="active" <?= $data['fields']['active'] ? 'checked' : '' ?>>
        ...
        @include(
            ...
            [
                ...
                'value'        => e($data['fields']['preview_text']),
                'id'           => 'preview_text',
                'name'         => 'preview_text',
                'load_scripts' => true,
            ])
