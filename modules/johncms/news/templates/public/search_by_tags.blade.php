...
@section('content')
    <div>
        <form action="<?= route('news.searchByTags') ?>" method="get" class="search-in-nav news-search mb-3" style="max-width: 500px;">
            <div class="input-with-inner-btn">
                <input name="tag" type="text" minlength="4" placeholder="<?= __('Enter a tag') ?>" value="<?= $query ?>" class="form-control pe-5 border-radius-12">
