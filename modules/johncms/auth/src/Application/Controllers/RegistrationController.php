...
use Johncms\Modules\Auth\Application\Services\RegistrationPermissions;
use Johncms\Modules\Auth\Application\UseCases\RegisterUserUseCase;
    ...
    public function __invoke(Request $request): ViewResponse
    {
        ...
        if ($this->currentUser->isValid() || ! $this->accessChecker->allows(RegistrationPermissions::REGISTER)) {
            return new ViewResponse(
                '@auth/public/registration-closed.twig',
                [
        ...
        if ($request->getMethod() === 'POST') {
            ...
            if ($result->isValid()) {
                ...
                return new ViewResponse(
                    '@auth/public/registration-result.twig',
                    [
                        'title'          => __('Registration'),
                        'page_title'     => __('Registration'),
                        'usid'           => $newUser->id,
