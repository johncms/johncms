...
@section('content')
    <div>
        <div class="row">
            <div class="col-md-6">
                <?php if ($data['result']): ?>
                <div class="alert alert-success"><?= __('The module has been successfully updated') ?></div>
                <?php else: ?>
                <div class="alert alert-danger"><?= __('An error occurred while updating the module. Check the log for details.') ?></div>
                <?php endif; ?>
            </div>
        </div>
