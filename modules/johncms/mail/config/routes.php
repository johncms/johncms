...
return static function (RouteCollection $router): void {
    ...
    $mailGroup = $router->group('', function (RouteCollection $r): void {
        ...
        $r->map(['GET', 'POST'], '/mail/block/{userId:number}', BlockUserController::class)->name('mail.block');
        $r->map(['GET', 'POST'], '/mail/unblock/{userId:number}', UnblockUserController::class)->name('mail.unblock');
