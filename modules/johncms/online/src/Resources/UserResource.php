...
class UserResource extends AbstractResource
{
    public function toArray(): array
    {
        ...
        return [
            ...
            'place_url'               => $place['url'],
            'user_agent'              => htmlspecialchars((string) $this->activity->user_agent),
            'ip'                      => htmlspecialchars((string) $this->activity->ip),
            'ip_via_proxy'            => htmlspecialchars((string) $this->activity->ip_via_proxy),
            'search_ip_url'           => '',
