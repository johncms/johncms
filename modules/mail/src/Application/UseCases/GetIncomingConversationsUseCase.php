...
final readonly class GetIncomingConversationsUseCase
{
    ...
    {
        return $this->mailMessageRepository->countIncomingConversations($this->currentUser->id);
    }

    public function getPage(int $limit, int $offset): ConversationListResultDTO
    {
        $users = $this->mailMessageRepository->getIncomingConversations($this->currentUser->id, $limit, $offset);
