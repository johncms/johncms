<?php return array (
  ...
  array (
    ...
    array (
      ...
      'You have not entered Nickname' => 'Jus neįvedėte slapyvardžio',
      'Nickname wrong length' => 'Neteisingas slapyvardžio ilgis',
      ...
      'You have not selected genger' => 'Jūs neesate pasirinkę jokio turinio',
      'The security code is not correct' => 'Neteisingas apsaugos kodas',
      'Selected Nickname is already in use' => 'Šitas slapyvardis jau naudojamas',
      ...
      'Your registratiton data' => 'Jus sėkmingai užregistruotas',
      'Your ID' => 'Jūsų ID',
