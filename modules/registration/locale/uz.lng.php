<?php return array (
  ...
  array (
    ...
    array (
      ...
      'You have not entered Nickname' => 'Tahallusni kiritmadingiz',
      'Nickname wrong length' => 'Taxallus uzunligi noto\'g\'ri',
      'Invalid characters' => 'Ruxsat etilmagan belgilar',
      'You have not entered password' => 'Parolni kiritmadingiz',
      'Invalid length' => 'Juda uzun',
      'You have not selected genger' => 'Jinsni tanlamadingiz',
      'The security code is not correct' => 'Rasm ko\'di xato',
      'Selected Nickname is already in use' => 'Tanlangan Taxallus band, boshqa tanlang',
      ...
      'Your registratiton data' => 'Sizning ma\'lumotlar',
      'Your ID' => 'Sizning ID',
