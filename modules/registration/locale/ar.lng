<?php return array (
  ...
  array (
    ...
    array (
      ...
      'You have not entered Nickname' => 'لم تقم بادخال العضوية',
      'Nickname wrong length' => 'الاسم طويل جدا',
      'Invalid characters' => 'احرف غير صالحه',
      'You have not entered password' => 'لم تقم بادخال كلمة المرور',
      'Invalid length' => 'طويل جدا',
      'You have not selected genger' => 'لم تقم بتحديد محتوى',
      'The security code is not correct' => 'رمز الامان غير صحيح',
      'Selected Nickname is already in use' => 'الاسم مسجل من قبل',
      ...
      'Your registratiton data' => 'بيانات التسجيل الخاصه بك',
      'Your ID' => 'المعرف',
