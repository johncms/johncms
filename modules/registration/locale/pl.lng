<?php return array (
  ...
  array (
    ...
    array (
      ...
      'You have not entered Nickname' => 'Nie wpisałeś nazwy',
      'Nickname wrong length' => 'Nieprawidłowa długość',
      ...
      'You have not selected genger' => 'Nie wybrałeś płci',
      'The security code is not correct' => 'Kod zabezpieczający nie jest poprawny',
      'Selected Nickname is already in use' => 'Wybrana nazwa użytkownika jest już w użyciu',
      ...
      'Your registratiton data' => 'Twoje dane rejestracyjne',
      'Your ID' => 'Twoje ID',
