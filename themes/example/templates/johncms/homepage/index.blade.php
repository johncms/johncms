...
@section('content')
    ...
    <div class="jumbotron shadow bg-white mt-3">
        <h1 class="display-4 fw-bold">EXAMPLE</h1>
        <p class="lead">
    ...
    <h1 class="fw-bold mt-5">Как писать свои темы?</h1>
    ...
    <h2 class="fw-bold mt-5">Общие понятия</h2>
    <ul>
        <li>
    ...
    <h2 class="fw-bold mt-4">Создаем свою тему</h2>
    <div class="ms-4">
        <p>
        ...
        <ol>
            ...
            <li>
                <span class="badge bg-success">На заметку</span> <span class="badge badge-secondary">Откуда?</span>
            ...
            <li>
                <span class="badge bg-success">На заметку</span> <span class="badge badge-secondary">Куда?</span>
