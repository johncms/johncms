...
(function ($) {
     ...
     *  - data
     */
    var SQLQueriesWidget = PhpDebugBar.Widgets.queryLogWidget = PhpDebugBar.Widget.extend({
        ...
        render: function () {
            ...
            this.bindAttr('data', function (data) {
                ...
                for (var sql = {}, duplicate = 0, i = 0; (data.statements && i < data.statements.length); i++) {
