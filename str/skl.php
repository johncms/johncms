...
echo "<a href=\"?\">Назад</a><br/>";require ("../incfiles/end.php");exit;}
...
echo 'Новый пароль выслан по указанному адресу<br/>';$_SESSION['newpar1']=1;}else{echo "Новый пароль уже выслан<br/>";}}
...
$_SESSION['newpar']=1;}else{echo "Код для восстановления уже выслан<br/>";}}
...
print'<form action=\'?act=go&amp;continue\' method=\'post\'>Ваш логин:<br/>'.
'<input type=\'text\' name=\'namm\' value=\'\' format=\'*N\'/><br/>Код для восстановления:<br/>'.
'<input type=\'text\' name=\'codepas\' value=\'\' format=\'*N\'/><br/><br/>'.
'<input type=\'submit\' value=\'ok\'/></form>';

require ("../incfiles/end.php");exit;}

echo "Восстановление пароля<br/>(Для этого у Вас в анкете должен быть указан и активирован e-mail адрес)<br/>";
print'<form action=\'?act=go\' method=\'post\'>Ваш логин:<br/>'.
'<input type=\'text\' name=\'namm\' value=\'\' format=\'*N\'/><br/>Ваш e-mail:<br/>'.
'<input type=\'text\' name=\'email\' value=\'\' format=\'*N\'/><br/><br/>'.
'<input type=\'submit\' value=\'ok\'/></form>';
