...
if($asd<$a && $asd>0){echo ' <a href="smile.php?act=cat&amp;d='.$d.'&amp;start=0&amp;'.SID.'">1</a> ... ';}
...
$i=$i+10;}
if($asd2<$a){echo ' ... <a href="smile.php?act=cat&amp;d='.$d.'&amp;start='.$ba2.'&amp;'.SID.'">'.$ba.'</a>';}
...
if($asd<$a && $asd>0){echo ' <a href="smile.php?act=adm&amp;start=0&amp;'.SID.'">1</a> ... ';}
...
$i=$i+10;}
if($asd2<$a){echo ' ... <a href="smile.php?act=adm&amp;start='.$ba2.'&amp;'.SID.'">'.$ba.'</a>';}
...
if($asd<$a && $asd>0){echo ' <a href="smile.php?act=prost&amp;start=0&amp;'.SID.'">1</a> ... ';}
...
$i=$i+10;}
if($asd2<$a){echo ' ... <a href="smile.php?act=prost&amp;start='.$ba2.'&amp;'.SID.'">'.$ba.'</a>';}
...
$_SESSION['refsm']=$ref;}
if ($dostmod==1){echo ' <a href="smile.php?act=adm&amp;">Смайлы для администрации</a><br/>';}
