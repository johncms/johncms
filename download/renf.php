...
if ($rights == 4 || $rights >= 6) {
    ...
    if (isset ($_POST['submit'])) {
        ...
        if (eregi("[^a-z0-9.()+_-]", $newf)) {
            echo
            "В новом названии файла <b>$newn</b> присутствуют недопустимые символы<br/>Разрешены только латинские символы, цифры и некоторые знаки ( .()+_- )<br /><a href='?act=renf&amp;file="
            . $file . "'>Повторить</a><br/>";
            require_once ('../incfiles/end.php');
            exit;
        }
