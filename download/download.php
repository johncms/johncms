...
switch ($act)
{
    ...
    case "delmes":
        if ($dostdmod == 1)
        {
            ...
            header("location: download.php?act=komm&id=$ms[refid]");
        } else
        {
            require ("../incfiles/head.php");
            require ("../incfiles/inc.php");
    ...
    case "search":
        ...
        if ($g > 10)
        {
            ...
            if ($start != 0)
            {
                echo '<a href="download.php?act=search&amp;srh=' . $srh . '&amp;page=' . ($page - 1) . '">&lt;&lt;</a> ';
            }
            if ($offpg != 1)
            {
                if ($asd < $g && $asd > 0)
                {
                    echo ' <a href="download.php?act=search&amp;srh=' . $srh . '&amp;page=1&amp;">1</a> .. ';
                }
                $page2 = $ba - $page;
                $pa = ceil($page / 2);
                $paa = ceil($page / 3);
                ...
                if ($page > 13)
                {
                    echo ' <a href="download.php?act=search&amp;srh=' . $srh . '&amp;page=' . $paa . '">' . $paa . '</a> <a href="download.php?act=search&amp;srh=' . $srh . '&amp;page=' . ($paa + 1) . '">' . ($paa + 1) .
                        '</a> .. <a href="download.php?act=search&amp;srh=' . $srh . '&amp;page=' . ($paa * 2) . '">' . ($paa * 2) . '</a> <a href="download.php?act=search&amp;srh=' . $srh . '&amp;page=' . ($paa * 2 + 1) . '">' . ($paa * 2 + 1) . '</a> .. ';
                } elseif ($page > 7)
                {
                ...
                if ($page2 > 12)
                {
                    echo ' .. <a href="download.php?act=search&amp;srh=' . $srh . '&amp;page=' . $paa2 . '">' . $paa2 . '</a> <a href="download.php?act=search&amp;srh=' . $srh . '&amp;page=' . ($paa2 + 1) . '">' . ($paa2 + 1) .
                        '</a> .. <a href="download.php?act=search&amp;srh=' . $srh . '&amp;page=' . ($paa3) . '">' . ($paa3) . '</a> <a href="download.php?act=search&amp;srh=' . $srh . '&amp;page=' . ($paa3 + 1) . '">' . ($paa3 + 1) . '</a> ';
                } elseif ($page2 > 6)
                {
                ...
                if ($asd2 < $g)
                {
                    echo ' .. <a href="download.php?act=search&amp;srh=' . $srh . '&amp;page=' . $ba . '">' . $ba . '</a>';
                }
            } else
            {
                echo "<b>[$page]</b>";
            ...
            echo "<form action='download.php'>Перейти к странице:<br/><input type='hidden' name='act' value='search'/><input type='hidden' name='srh' value='" . $srh .
...
<input type='submit' title='Нажмите для отправки' name='submit' value='добавить' />  
    ...
    case "komm":
        ...
        if ($countm > $kmess)
        {
            ...
            if ($start != 0)
            {
                echo '<a href="download.php?act=komm&amp;id=' . $id . '&amp;page=' . ($page - 1) . '">&lt;&lt;</a> ';
            }
            if ($offpg != 1)
            {
                if ($asd < $countm && $asd > 0)
                {
                    echo ' <a href="download.php?act=komm&amp;id=' . $id . '&amp;page=1&amp;">1</a> .. ';
                }
                $page2 = $ba - $page;
                $pa = ceil($page / 2);
                $paa = ceil($page / 3);
                ...
                if ($page > 13)
                {
                    echo ' <a href="download.php?act=komm&amp;id=' . $id . '&amp;page=' . $paa . '">' . $paa . '</a> <a href="download.php?act=komm&amp;id=' . $id . '&amp;page=' . ($paa + 1) . '">' . ($paa + 1) . '</a> .. <a href="?id=' . $id . '&amp;page=' . ($paa *
                ...
                if ($page2 > 12)
                {
                    echo ' .. <a href="download.php?act=komm&amp;id=' . $id . '&amp;page=' . $paa2 . '">' . $paa2 . '</a> <a href="download.php?act=komm&amp;id=' . $id . '&amp;page=' . ($paa2 + 1) . '">' . ($paa2 + 1) .
                        '</a> .. <a href="download.php?act=komm&amp;id=' . $id . '&amp;page=' . ($paa3) . '">' . ($paa3) . '</a> <a href="download.php?act=komm&amp;id=' . $id . '&amp;page=' . ($paa3 + 1) . '">' . ($paa3 + 1) . '</a> ';
                } elseif ($page2 > 6)
                {
                ...
                if ($asd2 < $countm)
                {
                    echo ' .. <a href="download.php?act=komm&amp;id=' . $id . '&amp;page=' . $ba . '">' . $ba . '</a>';
                }
            } else
            {
                echo "<b>[$page]</b>";
            ...
            echo "<form action='download.php'>Перейти к странице:<br/><input type='hidden' name='id' value='" . $id .
    ...
    case "new":
        ...
        if ($totalnew != 0)
        {
            ...
            if ($totalnew > 10)
            {
                ...
                if ($start != 0)
                {
                    echo '<a href="download.php?act=new&amp;page=' . ($page - 1) . '">&lt;&lt;</a> ';
                }
                ...
                if ($offpg != 1)
                {
                    ...
                    {
                        echo ' <a href="download.php?act=new&amp;page=1">1</a> .. ';
                    }
                    $page2 = $ba - $page;
                    $pa = ceil($page / 2);
                    $paa = ceil($page / 3);
                    ...
                    if ($page > 13)
                    {
                        echo ' <a href="download.php?act=new&amp;page=' . $paa . '">' . $paa . '</a> <a href="download.php?act=new&amp;page=' . ($paa + 1) . '">' . ($paa + 1) . '</a> .. <a href="download.php?act=new&amp;page=' . ($paa * 2) . '">' . ($paa * 2) .
                            '</a> <a href="download.php?act=new&amp;page=' . ($paa * 2 + 1) . '">' . ($paa * 2 + 1) . '</a> .. ';
                    } elseif ($page > 7)
                    {
                    ...
                    if ($page2 > 12)
                    {
                        echo ' .. <a href="download.php?act=new&amp;page=' . $paa2 . '">' . $paa2 . '</a> <a href="download.php?act=new&amp;page=' . ($paa2 + 1) . '">' . ($paa2 + 1) . '</a> .. <a href="download.php?act=new&amp;page=' . ($paa3) . '">' . ($paa3) .
                            '</a> <a href="download.php?act=new&amp;page=' . ($paa3 + 1) . '">' . ($paa3 + 1) . '</a> ';
                    } elseif ($page2 > 6)
                    {
                    ...
                    if ($asd2 < $totalnew)
                    {
                        echo ' .. <a href="download.php?act=new&amp;page=' . $ba . '">' . $ba . '</a>';
                    }
                } else
                {
                    echo "<b>[$page]</b>";
    ...
    case "zip":
        ...
        if ($count > 10)
        {
            ...
            if ($start != 0)
            {
                echo '<a href="download.php?act=zip&amp;file=' . $file . '&amp;page=' . ($page - 1) . '">&lt;&lt;</a> ';
            }
            $asd = $start - 10;
            $asd2 = $start + 20;
            if ($offpg != 1)
            {
                if ($asd < $count && $asd > 0)
                {
                    echo ' <a href="download.php?act=zip&amp;file=' . $file . '&amp;page=1">1</a> .. ';
                }
                $page2 = $ba - $page;
                $pa = ceil($page / 2);
                $paa = ceil($page / 3);
                ...
                if ($page > 13)
                {
                    echo ' <a href="download.php?act=zip&amp;file=' . $file . '&amp;page=' . $paa . '">' . $paa . '</a> <a href="download.php?act=zip&amp;file=' . $file . '&amp;page=' . ($paa + 1) . '">' . ($paa + 1) .
                        '</a> .. <a href="download.php?act=zip&amp;file=' . $file . '&amp;page=' . ($paa * 2) . '">' . ($paa * 2) . '</a> <a href="download.php?act=zip&amp;file=' . $file . '&amp;page=' . ($paa * 2 + 1) . '">' . ($paa * 2 + 1) . '</a> .. ';
                } elseif ($page > 7)
                {
                ...
                if ($page2 > 12)
                {
                    echo ' .. <a href="download.php?act=zip&amp;file=' . $file . '&amp;page=' . $paa2 . '">' . $paa2 . '</a> <a href="download.php?act=zip&amp;file=' . $file . '&amp;page=' . ($paa2 + 1) . '">' . ($paa2 + 1) .
                        '</a> .. <a href="download.php?act=zip&amp;file=' . $file . '&amp;page=' . ($paa3) . '">' . ($paa3) . '</a> <a href="download.php?act=zip&amp;file=' . $file . '&amp;page=' . ($paa3 + 1) . '">' . ($paa3 + 1) . '</a> ';
                } elseif ($page2 > 6)
                {
                ...
                if ($asd2 < $count)
                {
                    echo ' .. <a href="download.php?act=zip&amp;file=' . $file . '&amp;page=' . $ba . '">' . $ba . '</a>';
                }
            } else
            {
                echo "<b>[$page]</b>";
            ...
            echo "<form action='download.php'>Перейти к странице:<br/><input type='hidden' name='act' value='zip'/><input type='hidden' name='file' value='" . $file .
                "'/><input type='text' name='page' title='Введите номер страницы'/><br/><input type='submit' title='Нажмите для перехода' value='Go!'/></form>";
        }
...
<a href='?act=select&amp;cat=" . $cat . "'>Повторить</a><br/>";
                ...
                {
                    echo "В названии файла <b>$fname</b> присутствуют недопустимые символы<br/>Разрешены только латинские символы, цифры и некоторые знаки ( .()+_- )<br /><a href='?act=select&amp;cat=" . $cat . "'>Повторить</a><br/>";
                    require ('../incfiles/end.php');
                    exit;
                }
                if (eregi("[^a-z0-9.()+_-]", $newname))
                {
                    echo "В новом названии файла <b>$newname</b> присутствуют недопустимые символы<br/>Разрешены только латинские символы, цифры и некоторые знаки ( .()+_- )<br /><a href='?act=select&amp;cat=" . $cat . "'>Повторить</a><br/>";
                    require ('../incfiles/end.php');
                    exit;
                }
            ...
            if (!empty($_POST['fail1']))
            {
                ...
                if (eregi("[^a-z0-9.()+_-]", $tmp_name))
                {
                    echo "В названии файла <b>$tmp_name</b> присутствуют недопустимые символы<br/>Разрешены только латинские символы, цифры и некоторые знаки ( .()+_- )<br /><a href='?act=select&amp;cat=" . $cat . "'>Повторить</a><br/>";
                    require ('../incfiles/end.php');
                    exit;
                }
                if (eregi("[^a-z0-9.()+_-]", $newname))
    ...
    default:
        ...
        if ($total != 0)
        {
            ...
            if ($total > 10)
            {
                ...
                if ($start != 0)
                {
                    echo '<a href="download.php?cat=' . $cat . '&amp;page=' . ($page - 1) . '">&lt;&lt;</a> ';
                }
                $asd = $start - 10;
                $asd2 = $start + 20;
                if ($offpg != 1)
                {
                    if ($asd < $total && $asd > 0)
                    {
                        echo ' <a href="download.php?cat=' . $cat . '&amp;page=1">1</a> .. ';
                    }
                    $page2 = $ba - $page;
                    $pa = ceil($page / 2);
                    $paa = ceil($page / 3);
                    ...
                    if ($page > 13)
                    {
                        echo ' <a href="download.php?cat=' . $cat . '&amp;page=' . $paa . '">' . $paa . '</a> <a href="download.php?cat=' . $cat . '&amp;page=' . ($paa + 1) . '">' . ($paa + 1) . '</a> .. <a href="download.php?cat=' . $cat . '&amp;page=' . ($paa *
                            2) . '">' . ($paa * 2) . '</a> <a href="download.php?cat=' . $cat . '&amp;page=' . ($paa * 2 + 1) . '">' . ($paa * 2 + 1) . '</a> .. ';
                    } elseif ($page > 7)
                    {
                    ...
                    if ($page2 > 12)
                    {
                        echo ' .. <a href="download.php?cat=' . $cat . '&amp;page=' . $paa2 . '">' . $paa2 . '</a> <a href="download.php?cat=' . $cat . '&amp;page=' . ($paa2 + 1) . '">' . ($paa2 + 1) . '</a> .. <a href="download.php?cat=' . $cat . '&amp;page=' . ($paa3) .
                            '">' . ($paa3) . '</a> <a href="download.php?cat=' . $cat . '&amp;page=' . ($paa3 + 1) . '">' . ($paa3 + 1) . '</a> ';
                    } elseif ($page2 > 6)
                    {
                    ...
                    if ($asd2 < $totalnew)
                    {
                        echo ' .. <a href="download.php?cat=' . $cat . '&amp;page=' . $ba . '">' . $ba . '</a>';
                    }
                } else
                {
                    echo "<b>[$page]</b>";
                ...
                echo "<form action='download.php'>Перейти к странице:<br/><input type='hidden' name='cat' value='" . $cat .
                    "'/><input type='text' name='page' title='Введите номер страницы'/><br/><input type='submit' title='Нажмите для перехода' value='Go!'/></form>";
            }
            if ($totalcat >= 1)
            {
