                ...
                while ($array = mysql_fetch_array($psk))
                {
                    ...
                    if (stristr($pmsg, $srh))
                    {
                        ...
                        if (($dostsadm == 1 || $tem1['close'] != 1) && ($tem1['moder'] == 1))
                        {
                            ...
                            $text = mb_substr($array['text'], 0, 500);
                            ...
                            if (!empty($array['attach']))
                            {
                                ...
                                $text = "$text<br/>Прикрепленный файл: <a href='index.php?act=file&amp;id=" . $array['id'] . "'>$array[attach]</a> ($fls кб.)";
                            }
                            if ($tem1['vip'] == 1)
                            {
                            ...
                            $res[] = "$tinf <a href='index.php?id=" . $tem1['id'] . "&amp;page=" . $page . "'>[$frm[text]/$razd[text]/$tem1[text]]</a><br/>$tst $hd $text<br/>";
                        }
                    }
                }
                break;
