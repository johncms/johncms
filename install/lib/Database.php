...
(2, 0, 'Объявления', 'obyavleniya', NULL, NULL, NULL, '$nowDt', '$nowDt');"
        ...
        $connection->statement(
            "INSERT INTO `news_articles` (`id`, `section_id`, `active`, `active_from`, `active_to`, `name`, `page_title`, `code`, `keywords`, `description`, `preview_text`, `text`, `view_count`, `tags`, `created_by`, `updated_by`, `attached_files`, `created_at`, `updated_at`) VALUES
(1, 1, 1, NULL, NULL, 'Добро пожаловать на сайт!', NULL, 'dobro-pozhalovat-na-sajt', NULL, NULL, '<p>Рады приветствовать вас на нашем сайте.</p>', '<p>Рады приветствовать вас на нашем сайте. Здесь вы найдёте актуальные новости, полезные материалы и живое общение.</p>', 0, NULL, 1, 1, NULL, '$nowDt', '$nowDt'),
(2, 1, 1, NULL, NULL, 'Сайт запущен', NULL, 'sajt-zapushhen', NULL, NULL, '<p>Наш сайт официально открыт для посетителей.</p>', '<p>Наш сайт официально открыт для посетителей. Следите за обновлениями — впереди много интересного!</p>', 0, NULL, 1, 1, NULL, '$nowDt', '$nowDt'),
(3, 2, 1, NULL, NULL, 'Правила сайта', NULL, 'pravila-sajta', NULL, NULL, '<p>Просим всех участников ознакомиться с правилами.</p>', '<p>Просим всех участников ознакомиться с правилами сайта. Уважайте друг друга, не допускайте грубости и спама. Администрация оставляет за собой право удалять материалы, нарушающие правила.</p>', 0, NULL, 1, 1, NULL, '$nowDt', '$nowDt'),
(4, 2, 1, NULL, NULL, 'Технические работы', NULL, 'tehnicheskie-raboty', NULL, NULL, '<p>Плановые технические работы завершены.</p>', '<p>Плановые технические работы успешно завершены. Все функции сайта работают в штатном режиме. Спасибо за терпение!</p>', 0, NULL, 1, 1, NULL, '$nowDt', '$nowDt');"
        );
        $connection->statement(
