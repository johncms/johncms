...
return [
    ...
    'final_warning'            => 'WARNING!<br>After installation, you must delete folder/<span style="color:red;">install</span>',
    ...
    'install_note'             => '<p><strong class="d-block text-center">Welcome!</strong><br>List of changes located in the file <a href="?act=changelog">CHANGELOG.md</a><br>Additional information is available on the official project website <a href="http://johncms.com">http://johncms.com</a><br>Installing and using JohnCMS, means complete acceptance of the terms of the <a href="?act=license">license</a><br></p>',
