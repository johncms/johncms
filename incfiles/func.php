...
############################
function trans($str){
$str=strtr($str,array("a"=>"а","b"=>"б","v"=>"в","g"=>"г","d"=>"д","e"=>"е","yo"=>"ё","zh"=>"ж","z"=>"з","i"=>"и","j"=>"й","k"=>"к","l"=>"л","m"=>"м","n"=>"н","o"=>"о","p"=>"п","r"=>"р","s"=>"с","t"=>"т","u"=>"у","f"=>"ф","h"=>"х","c"=>"ц","ch"=>"ч","w"=>"ш","sh"=>"щ","q"=>"ъ","y"=>"ы","x"=>"э","yu"=>"ю","ya"=>"я",
"A"=>"А","B"=>"Б","V"=>"В","G"=>"Г","D"=>"Д","E"=>"Е","YO"=>"Ё","ZH"=>"Ж","Z"=>"З","I"=>"И","J"=>"Й","K"=>"К","L"=>"Л","M"=>"М","N"=>"Н","O"=>"О","P"=>"П","R"=>"Р","S"=>"С","T"=>"Т","U"=>"У","F"=>"Ф","H"=>"Х","C"=>"Ц","CH"=>"Ч","W"=>"Ш","SH"=>"Щ","Q"=>"Ъ","Y"=>"Ы","X"=>"Э","YU"=>"Ю","YA"=>"Я"));
return $str;}
#############################
...
while($k=readdir($d)){  if (ereg (".gif$", "$k")){
$file2=$k; 
$file2=str_replace(".gif","",$file2);
$trfile=trans($file2);
