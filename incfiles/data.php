...
if (!empty($_SESSION[pid]))
{
    ...
    if ($login == $nickadmina || $login == $nickadmina2 || $statad == "7")
    {
        $dostadm = "1";
    }
    if ($login == $nickadmina || $login == $nickadmina2 || $statad == "7" || $statad == "6")
    {
        $dostsmod = "1";
    }
    if ($login == $nickadmina || $login == $nickadmina2 || $statad == "7" || $statad == "6" || $statad == "5")
    {
        $dostlmod = "1";
    }
    if ($login == $nickadmina || $login == $nickadmina2 || $statad == "7" || $statad == "6" || $statad == "4")
    {
        $dostdmod = "1";
    }
    if ($login == $nickadmina || $login == $nickadmina2 || $statad == "7" || $statad == "6" || $statad == "3")
    {
        $dostfmod = "1";
    }
    if ($login == $nickadmina || $login == $nickadmina2 || $statad == "7" || $statad == "6" || $statad == "2")
    {
        $dostcmod = "1";
    }
    if ($login == $nickadmina || $login == $nickadmina2 || $statad == "1" || $statad == "7" || $statad == "6")
    {
        $dostkmod = "1";
    }
    if ($login == $nickadmina || $login == $nickadmina2 || $statad >= "1")
    {
        $dostmod = "1";
    }
} else
