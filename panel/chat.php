...
$a1=mysql_num_rows($a);
if ($v1==0){echo "<option value='vik'>викторина</option>";}
if ($a1==0){echo "<option value='in'>интим</option>";}
...
if ($rei1!=0){echo "<a href='chat.php?act=up&amp;id=".$mass[id]."'>Вверх</a> | ";}
if ($rei!=0){echo "<a href='chat.php?act=down&amp;id=".$mass[id]."'>Вниз</a> | ";}
