...
switch ($mod) {
    ...
    case 'phrases':
        ...
        if ($total) {
            ...
            if ($total > $kmess) {
                echo '<div class="topmenu">' . functions::display_pagination('?act=languages&amp;mod=phrases&amp;language=' . $language . '&amp;module=' . $name_module . '&amp;symbol=' . $symbol . '&amp;', $start, $total,
                        $kmess) . '</div>' .
    ...
    case 'search':
        ...
        if ($total) {
            ...
            if ($total > $kmess) {
                echo '<div class="topmenu">' . functions::display_pagination('?act=languages&amp;mod=search&amp;language=' . $language . '&amp;module=' . $name_module . '&amp;search=' . urlencode($search) . '&amp;', $start, $total,
                        $kmess) . '</div>' .
