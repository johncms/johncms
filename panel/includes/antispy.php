...
class scaner {
    ...
    */
    ...
    public $good_files = array (
        ...
        '../download/includes/addkomm.php',
        '../download/includes/arc.php',
        '../download/includes/delcat.php',
        '../download/includes/delmes.php',
        '../download/includes/dfile.php',
        '../download/includes/down.php',
        '../download/includes/import.php',
        '../download/includes/komm.php',
        '../download/includes/makdir.php',
        '../download/includes/new.php',
        '../download/includes/opis.php',
        '../download/includes/preview.php',
        '../download/includes/rat.php',
        '../download/includes/refresh.php',
        '../download/includes/ren.php',
        '../download/includes/screen.php',
        '../download/includes/search.php',
        '../download/includes/select.php',
        '../download/includes/upl.php',
        '../download/includes/view.php',
        '../download/includes/zip.php',
        '../download/index.php',
