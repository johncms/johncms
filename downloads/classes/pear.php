...
defined('MOBICMS') || die('Error:restricted access');
...
class PEAR
{
    ...
    public function & raiseError($message = null, $code = null, $mode = null, $options = null, $userinfo = null, $error_class = null, $skipmsg = false)
    {
        ...
        if (isset($this, $this->_expected_errors) && count($this->_expected_errors) > 0 && count($exp = end($this->_expected_errors))) {
...
class PEAR_Error
{
    ...
    {
        $modes = [];
        $levels = [E_USER_NOTICE => 'notice', E_USER_WARNING => 'warning', E_USER_ERROR => 'error'];
        if ($this->mode & PEAR_ERROR_CALLBACK) {
