...
if (!$req_down->rowCount() || !is_file($res_down['dir'] . '/' . $res_down['name']) || (pathinfo($res_down['name'], PATHINFO_EXTENSION) != 'txt' && !isset($_GET['more'])) || ($res_down['type'] == 3 && $rights < 6 && $rights != 4)) {
