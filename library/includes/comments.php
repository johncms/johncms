...
if ($req_obj->rowCount()) {
    ...
    $context_top =
        ...
        '<span class="gray">' . _t('Who added') . ':</span> <a href="' . $config['homeurl'] . '/profile/?user=' . $res_obj['uploader_id'] . '">' . $tools->checkout($res_obj['uploader']) . '</a> (' . $tools->displayDate((int) $res_obj['time']) . ')<br>' .
