...
#[AsCommand(
    name: 'module:enable',
    description: 'Switch an installed module back on',
)]
final class ModuleEnableCommand extends ModuleLifecycleCommand
{
    ...
    {
        return $this->report($input, $output, $this->service->enable((string) $input->getArgument('module')));
    }
}
