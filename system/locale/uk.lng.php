<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Users on registration' => 'Користувачі, очікуючі на реєстрацію',
      ...
      'opcache extension' => 'розширення opcache',
      'It is recommended to install the php opcache extension for better performance.' => 'Рекомендується встановити розширення php opcache для кращої продуктивності.',
      'It is recommended to enable the php opcache extension to improve performance.' => 'Рекомендується увімкнути розширення php opcache для підвищення продуктивності.',
      'Version of the database server' => 'Версія сервера бази даних',
      'The system requires a MySQL server version %s or higher or MariaDB %s or higher.' => 'Система потребує версію сервера MySQL %s або вище або MariaDB %s або вище.',
...
PHP should work with the default driver: <a href="https://www.php.net/manual/en/intro.mysqlnd.php" target="_blank">MySQL Native Driver (mysqlnd)</a>.' => 'Ми використовуємо strict data type при розробці системи. CMS не буде працювати коректно, якщо драйвер для роботи з базою даних повертає неправильні типи даних.
PHP повинен працювати з драйвером за замовчуванням: <a href="https://www.php.net/manual/en/intro.mysqlnd.php" target="_blank">MySQL Native Driver (mysqlnd)</a>.',
      'Reply' => 'Відповісти',
      ...
      'Bindings' => 'Прив\'язки',
      'Time' => 'Час',
      'Set Light Theme' => 'Увімкнути світлу тему',
      'Set Dark Theme' => 'Увімкнути темну тему',
      ...
      'We use cookies to improve the site. By continuing to use the site, you agree to our %sPrivacy Policy%s.' => 'Ми використовуємо файли cookie, щоб покращити сайт. Продовжуючи користуватися сайтом, ви погоджуєтеся з нашою %sПолітикою конфіденційності%s.',
      'Accept' => 'Прийняти',
