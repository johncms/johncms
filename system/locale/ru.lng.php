...
Число показано, чтобы поддержку старой схемы не убрали, пока она ещё используется.',
      ...
      'You are not allowed to open this page.' => 'У вас нет доступа к этой странице.',
      'Access denied' => 'Доступ запрещён',
      'Signed in' => 'Вход выполнен',
      'Sign-in failed' => 'Неудачная попытка входа',
      'Signed out' => 'Выход из аккаунта',
      'Password changed' => 'Пароль изменён',
      'Password recovery requested' => 'Запрошено восстановление пароля',
      'Password recovered' => 'Пароль восстановлен',
      'Device signed out' => 'Устройство отключено',
      'Role granted' => 'Роль выдана',
      'Role revoked' => 'Роль снята',
      'Browse the site as another user' => 'Просматривать сайт от имени другого пользователя',
      'Started browsing as the user' => 'Вход под пользователем',
      'Stopped browsing as the user' => 'Выход из режима просмотра под пользователем',
      'Action while browsing as the user' => 'Действие в режиме просмотра под пользователем',
      'You are already signed in as yourself' => 'Вы и так вошли под своей учётной записью',
      'User does not exists' => 'Пользователь не существует',
      'You cannot browse as somebody who outranks you' => 'Нельзя просматривать сайт от имени того, кто выше вас',
      'You are browsing the site as %s.' => 'Вы просматриваете сайт от имени пользователя %s.',
      'Return to my account' => 'Вернуться в свою учётную запись',
      'The sign-in was cancelled' => 'Вход отменён',
      'The service did not return a sign-in code' => 'Сервис не вернул код авторизации',
      'The service did not return an access token' => 'Сервис не вернул токен доступа',
      'The service is not responding, please try again later' => 'Сервис не отвечает, попробуйте позже',
      'The service refused the sign-in' => 'Сервис отклонил авторизацию',
      'This email address is already registered. Sign in with your password to link the account.' => 'Этот адрес уже зарегистрирован. Войдите по паролю, чтобы привязать аккаунт.',
      'The sign-in attempt has expired, please try again' => 'Время на вход истекло, попробуйте ещё раз',
      'The sign-in attempt could not be verified, please try again' => 'Не удалось проверить запрос на вход, попробуйте ещё раз',
      'The service did not return an account identifier' => 'Сервис не вернул идентификатор аккаунта',
      'This is the only way to sign in to the account. Set a password first.' => 'Это единственный способ входа в аккаунт. Сначала задайте пароль.',
      'This sign-in service is not available' => 'Этот сервис входа недоступен',
      'Your account is awaiting approval' => 'Ваш аккаунт ожидает подтверждения администратором',
      'Registration is closed on this site' => 'Регистрация на сайте закрыта',
      'Finish signing up' => 'Завершение регистрации',
      'Or sign in with' => 'Или войдите через',
      'Almost done. Choose a username to finish creating your account.' => 'Почти готово. Выберите имя пользователя, чтобы завершить создание аккаунта.',
      'E-mail' => 'E-mail',
      'The verification has expired, please try again' => 'Срок действия проверки истек, попробуйте еще раз',
      'The verification did not pass, please try again' => 'Проверка не пройдена, попробуйте еще раз',
      'The verification service is unavailable, please try again later' => 'Сервис проверки недоступен, попробуйте позже',
      'Picture with a code' => 'Картинка с кодом',
      'Picture width' => 'Ширина картинки',
      'Picture height' => 'Высота картинки',
      'Picture format' => 'Формат картинки',
      'A narrow picture crowds the characters together and makes them hard to read' => 'На узкой картинке символы наезжают друг на друга и плохо читаются',
      'Minimum code length' => 'Минимальная длина кода',
      'Maximum code length' => 'Максимальная длина кода',
      'Public key' => 'Публичный ключ',
      'Secret key' => 'Секретный ключ',
      'Client key' => 'Клиентский ключ',
      'Server key' => 'Серверный ключ',
      'The key of the widget. It is part of the page and is not a secret' => 'Ключ виджета. Он является частью страницы и не является секретом',
