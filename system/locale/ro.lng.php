...
PHP ar trebui să funcționeze cu șoferul implicit: <a href="https://www.php.net/manual/en/intro.mysqlnd.php" target="_blank">MySQL Native Driver (mysqlnd)</a>.',
      ...
      'You cannot add the message so often<br>Please, wait' => 'Nu poti adauga in mesaj asa de des. Te rog asteapta',
      'seconds' => 'secunde',
      ...
      'You cannot add the message so often. Please, wait %value% seconds.' => 'Nu poti adauga in mesaj asa de des. Te rog asteapta, %value% secunde',
