<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Yes' => 'Có',
      'No' => 'Không',
      'PHP extension PDO must be installed' => 'Tiện ích mở rộng PDO của PHP phải được cài đặt',
      'Imagick or GD extension' => 'Tiện ích Imagick hoặc GD',
      'You must install the php extension Imagick or GD' => 'Bạn cần kích hoạt tiện ích PHP Imagick hoặc GD',
      'zlib extension' => 'zlib extension',
      'PHP extension zlib must be installed' => 'Tiện ích PHP zlib cần được cài đặt',
      'mbstring extension' => 'mbstring extension',
      'PHP extension mbstring must be installed' => 'Tiện ích mở rộng PHP mbstring cần được cài đặt',
      'fileinfo extension' => 'fileinfo extension',
      'PHP extension fileinfo must be installed' => 'Tiện ích PHP fileinfo cần được cài đặt',
      'opcache extension' => 'opcache extension',
      'It is recommended to install the php opcache extension for better performance.' => 'Bạn nên cài đặt phần mở rộng php opcache để có hiệu suất tốt hơn.',
      'It is recommended to enable the php opcache extension to improve performance.' => 'Bạn nên kích hoạt phần mở rộng php opcache để có hiệu suất tốt hơn.',
      'Version of the database server' => 'Phiên bản của máy chủ cơ sở dữ liệu',
      'The system requires a MySQL server version %s or higher or MariaDB %s or higher.' => 'Hệ thống yêu cầu máy chủ MySQL phiên bản %s trở lên hoặc MariaDB %s trở lên.',
      'mysqlnd test' => 'mysqlnd test',
...
PHP should work with the default driver: <a href="https://www.php.net/manual/en/intro.mysqlnd.php" target="_blank">MySQL Native Driver (mysqlnd)</a>.' => 'Chúng tôi sử dụng kiểm tra kiểu dữ liệu nghiêm ngặt khi phát triển hệ thống. CMS sẽ không hoạt động chính xác nếu trình điều khiển làm việc với cơ sở dữ liệu trả về kiểu dữ liệu không chính xác.
PHP sẽ hoạt động với trình điều khiển mặc định: <a href="https://www.php.net/manual/en/intro.mysqlnd.php" target="_blank">MySQL Native Driver (mysqlnd)</a>.',
      'Reply' => 'Trả lời',
      ...
      'seconds' => 'giây',
      'Message already exists' => 'Tin nhắn đã tồn tại',
      'Unread' => 'Chưa đọc',
      ...
      'Value is required and can\'t be empty' => 'Giá trị là bắt buộc, không được để trống',
