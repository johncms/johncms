<?php return array (
  ...
  array (
    ...
    array (
      ...
      'The PHP version must be at least %s' => 'يجب أن يكون إصدار PHP %s على الأقل',
      'Yes' => 'بله',
      'No' => 'نه',
      'Reply' => 'رد ',
      ...
      'Supervisor' => 'مشرف',
      'You have a ban' => 'لديك حظر',
      'The form submitted did not originate from the expected site' => 'شكل المقدمة لم تنشأ من المتوقع الموقع',
      'You cannot add the message so often. Please, wait %value% seconds.' => 'لا يمكنك إضافة الرسالة حتى غالباً. الرجاء الانتظار %value% ثانية.',
