...
return static function (ContainerConfigurator $container): void {
    ...
    // Both read config/csrf.php: scalar and array arguments the container cannot autowire.
    $services->set(CsrfExemptions::class)->factory([CsrfExemptions::class, 'create']);
    $services->set(CsrfMiddleware::class)->factory([CsrfMiddleware::class, 'create']);
